...
안녕하세요 Kyun2da 입니다~  
첫 글 포스팅을 하니 매우 설레네요  
Jekyll을 활용한 Github blog는 markdown 문법을 사용하여 포스팅을 하는데요  
...
### 실행 결과
![Image of Yaktocat](/img/in-post/text01.gif)

## 1.2 문장의 중간을 강조 방법 (bold와 italic)
문장의 중간에 강조하는 방법이 두가지가 있는데 **두껍게(Bold)** 하는 방법과 *기울이기(italic)*의 방법이 있습니다.
